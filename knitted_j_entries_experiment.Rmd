...
data <- readRDS("N:/QGIS/POSTGRAD_GIS/gis_code_github/tidied_cpc_data.rds")
stations <- readRDS("N:/QGIS/POSTGRAD_GIS/gis_code_github/stations2.rds")
